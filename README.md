...
### Net Revenue
![Monthly Net Revenue By Year](figures/Monthly_Net_Revenue_by_Year.png)

### Sales by Building Type and Year
![C](figures/Sales_by_Building_Type_and_Year.png)

### Customers Age Distribution
![Location Comparison](figures/Distribution_of_Customers_Age.jpg)
